...
class PointCloudVisualizer:
    ...
    def visualize(self, a=None, b=None, c=None, d=None):
        """
        Visualizes the point cloud in an interactive mode using Plotly with color coding for point classes.
        Optionally adds a plane to the plot if plane parameters are provided.
        """
        ...
        # If plane parameters are provided, plot the plane
        if a is not None and b is not None and c is not None and d is not None:
            ...
            xx, yy, zz = self.plot_plane(a, b, c, d, x_range, y_range)

            # Add the plane as a surface to the plot
...
if __name__ == "__main__":
    ...
    # Visualize the point cloud with class-specific colors and a plane intersection
    # Example plane: 2x + 3y - z + 5 = 0 (a=2, b=3, c=-1, d=5)
    visualizer.visualize(a=2, b=3, c=-1, d=5)
